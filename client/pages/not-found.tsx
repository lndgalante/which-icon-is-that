...
import { LeftMiddle } from "@modules/not-found/components/Shapes/LeftMiddle";
import { LeftBottom } from "@modules/not-found/components/Shapes/LeftBottom";
import { LeftMiddleTop } from "@modules/not-found/components/Shapes/LeftMiddleTop";
import { LeftMiddleBottom } from "@modules/not-found/components/Shapes/LeftMiddleBottom";

import { RightTop } from "@modules/not-found/components/Shapes/RightTop";
import { RightMiddle } from "@modules/not-found/components/Shapes/RightMiddle";
import { RightBottom } from "@modules/not-found/components/Shapes/RightBottom";
import { RightTopSecondary } from "@modules/not-found/components/Shapes/RightTopSecondary";

function NotFound() {
  return (
    <Stack backgroundColor="brand.lightOrange" height="80vh" position="relative"
      justifyContent="center" alignItems="center" spacing={6}>
