...
export function DropZone() {
  return (
    <Stack minWidth={{ base: 335, md: 454 }} minHeight={{ base: 208, md: 262 }} borderRadius={24} bottom={-122} padding={6} transition="all 400ms ease" _hover={{ transform: 'scale(1.025)', boxShadow: 'xl' }} position="absolute" backgroundColor="white" boxShadow="lg">
