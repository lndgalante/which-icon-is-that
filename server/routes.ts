...
import { getIconNamesByIconName } from './controllers/getIconNamesByIconName.ts';
...
router
  ...
  .get('/icon/libraries/:iconLibrary', getIconLibraries)
  ...
  /* Used on gallery page to get all the icon names for the icon name input */
  .get('/icon/names/find/:iconName', getIconNamesByIconName)
  /* Used on gallery page to get all the icons by icon name and icon library */
  .get('/icons/find/:iconName/:iconLibrary', getIconsByIconNameAndIconLibrary)
